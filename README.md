...
- [x] What is the purpose of using _sessions_?
        ...
        Sessions is used to allow a server to store information about a client

- [x] What does bcrypt do to help us store passwords in a secure manner.

        bcrypt hashes passwords easily

- [x] What does bcrypt do to slow down attackers?

        It has an algorithm that hashes the information multiple times. The attaker would need to have the has, know the algorithm and how many rounds were used when the has was generated.
